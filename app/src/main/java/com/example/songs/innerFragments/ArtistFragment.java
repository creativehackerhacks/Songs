...
public class ArtistFragment extends Fragment {
    ...
    public static final String ARTIST_LIST_FRAGMENT = ArtistFragment.class.getSimpleName();
...
//        mRecyclerView.setLayoutManager(new LinearLayoutManager(context, RecyclerView.VERTICAL, false));
    ...
    private View.OnClickListener mClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Fragment artistListFragment = ArtistListFragment.getInstance();
            Bundle bundle = new Bundle();
            bundle.putString("ALBUM_NAME", mArtistRecyclerViewAdapter.getArtistsList().get(position).getArtistName());
